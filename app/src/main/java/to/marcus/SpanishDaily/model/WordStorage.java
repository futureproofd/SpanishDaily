package to.marcus.SpanishDaily.model;
...
public class WordStorage{
    ...
    /*
    Load DataSet: newDataSet determined upon BaseApplication exection
     */
    public WordStorage(Context appContext, boolean newDataSet){
        mSerializer = new ObjectSerializer(appContext, WORDS_DATASET);
        if (newDataSet) {
            try{
                mWords = mSerializer.loadDefaultWords(Constants.JSON_DEFAULT_DATASET);
            }catch (Exception e){
